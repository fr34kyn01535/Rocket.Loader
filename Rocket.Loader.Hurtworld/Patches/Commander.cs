...
namespace Rocket.RocketLoader.Hurtworld.Patches
{
    ...
    public class ConsoleManager : Patch
    {
        public override void Apply()
        {
            //Execute
            MethodDefinition Execute = GetInterfaceMethod("ExecuteConsole");
            MethodDefinition execute = Type.Methods.AsEnumerable().Where(m => m.Name == "ExecuteCommand").FirstOrDefault();
