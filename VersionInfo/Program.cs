...
namespace VersionInfo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            wc.DownloadData(String.Format("http://api.rocket.foundation/VersionInfo/report.php?build={0}&buildid={1}&rocketversion={2}&unturnedversion={3}", args[1], args[2], getRocketVersion(), getUnturnedVersion()));
        }
